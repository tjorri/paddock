...
var _ = Describe("Phase 2a P0 hotfix validation (hostile harness)", Ordered, func() {
	...
	AfterAll(func() {
		...
		// Theme 2 broker-hygiene specs (F-11, F-14, F-16, F-17) each
		// create their own namespace via mustCreateNamespace with
		// inline DeferCleanup; list them here as a belt-and-braces
		// drain while the controller is still alive.
