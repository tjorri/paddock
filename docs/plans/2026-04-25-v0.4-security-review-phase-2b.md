...
**Spec:** [`docs/plans/2026-04-25-v0.4-security-review-phase-2b-design.md`](./2026-04-25-v0.4-security-review-phase-2b-design.md).
...
- `docs/security/2026-04-25-v0.4-audit-findings.md` — F-19 / F-38 / F-45 `Test gap correlation` rows updated to point at the new E2E coverage.
...
(If this branch was deleted after PR-merge cleanup and the user re-invoked the plan from `main`, recreate it: `git checkout -b security/v0.4-review-phase-2b main`. The design doc `docs/plans/2026-04-25-v0.4-security-review-phase-2b-design.md` should already exist in `main`.)
...
spec (docs/security/2026-04-25-v0.4-test-gaps.md §4). Each flag emits
